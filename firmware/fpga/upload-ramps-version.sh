...
# Name of the main cpp file (without extension) is expected as an argument to this script.
$AVR_DIR/bin/avr-g++ -O -DF_CPU=16000000UL -DRAMPS -mmcu=atmega2560 -c -o $1.o $1.cpp \
